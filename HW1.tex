...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Claim 4 - Let $l_i$ be the diameter of the longest, shortest path in $G[P_i] \cup H_i$ with diameter $D$. Then at least $\lfloor \frac{D}{2} \rfloor$ vertices of $l_i$ are in $G[P_i]$:
